...
$user = $_SESSION['name'];
?>
  <link href="../css/vd.css" rel="stylesheet">
              ...
              if(!isset($_GET["id"]))
               {
                 ...
                 $prv= "../".$entity->getPreview();
                 $tmb= "../".$entity->getThumbnail();

                  
                ?>

          <!-- Page Heading -->
          <h1 class="h3 mt-4 text-gray-800 "><?php echo $pg_title; ?> </h1>
          <div class="row ">

            <div class="col-md-8  pb-3 bg-gray-100 ">
              <div class="container">
                <div class="video-container" id="video-container">
                  ...
                  <video controls class="video" id="video" height="350" preload="metadata" poster="<?php echo$tmb ?>"
                    id="plyr">
                    <source src="<?php echo$prv ?>"  type="video/mp4"></source>
                  </video>
                ...
                <p id="vdsc" class="cart-title pb-5 mt-2">
            ...
            <div class="col-md-4  overflow-auto " style="height:100vh;">
              ...
              <?php 
                  ...
                  echo $CorsProvider->creates($entity,$userid);
